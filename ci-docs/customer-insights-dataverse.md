...
The **Microsoft Dataverse** қадам Customer Insights мәліметтерін өзіңіздің деректеріңізбен қосуға мүмкіндік береді Dataverse кезінде орта [Customer Insights ортасын жасау](create-environment.md).
...
Әкімшілер Customer Insights параметрін барын қосу үшін теңшей алады Dataverse қоршаған орта. URL мекенжайын беру арқылы Dataverse орта, ол олардың жаңа Customer Insights ортасына қосылады.
...
Деректерді ортақ пайдалануды қосу Microsoft Dataverse сіздің ортаңыз болғанда [өзіңізді пайдаланады Azure Data Lake Storage тіркелгі](own-data-lake-storage.md) қосымша конфигурация қажет. Customer Insights ортасын орнатқан пайдаланушыда кем дегенде болуы керек **Blob деректерін оқу құралы** бойынша рұқсаттар *CustomerInsights* ішіндегі контейнер Azure Data Lake Storage тіркелгі.
...
- A арасында бір-бір салыстыру бар Dataverse ұйымдастыру және а Azure Data Lake Storage тіркелгі. Бір рет а Dataverse ұйым сақтау тіркелгісіне қосылған болса, ол басқа сақтау тіркелгісіне қосыла алмайды. Бұл шектеу а Dataverse бірнеше сақтау тіркелгілерін толтырмайды.
- Azure Data Lake сақтау тіркелгісіне кіру үшін Azure Private Link орнату қажет болса, деректерді ортақ пайдалану жұмыс істемейді, себебі ол желіаралық қалқанның артында. Dataverse қазіргі уақытта Жеке сілтеме арқылы жеке соңғы нүктелерге қосылуды қолдамайды.
...
1. Біздің инженерден іске қосу үшін қажет екі PowerShell сценарийін жүктеп алыңыз [GitHub репо](https://github.com/trin-msft/byol).
    1. `CreateSecurityGroups.ps1`
       ...
       - Бұл PowerShell сценарийі Azure жазылымында екі қауіпсіздік тобын жасайды. Біреуі Оқырман тобына, екіншісі Қатысушы тобына және жасайды Microsoft Dataverse осы екі қауіпсіздік тобының иесі ретінде қызмет көрсету.
...
Қосылымды жою тәуелділіктерге байланысты сәтсіз болса, тәуелділіктерді де жою керек. Қосымша ақпаратты қараңыз [Тәуелділіктерді жою](/power-platform/alm/removing-dependencies).

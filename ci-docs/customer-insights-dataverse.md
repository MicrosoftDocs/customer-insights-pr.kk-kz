...
- А Microsoft Dataverse орта тек бір сақтау тіркелгісіне қосыла алады. Ол ортаны конфигурациялағанда ғана қолданылады [пайдаланыңыз Azure Data Lake Storage](own-data-lake-storage.md).
...
- Деректермен бөлісу Azure Private Link параметріне кіру үшін қажет болса, жұмыс істемейді Azure Data Lake Storage тіркелгі, себебі ол брандмауэрдің артында. Dataverse қазіргі уақытта Жеке сілтеме арқылы жеке соңғы нүктелерге қосылуды қолдамайды.

...
ms.locfileid: "7732271"
---
# <a name="work-with-customer-insights-apis"></a>Customer Insights API жүйесімен жұмыс істеу

Dynamics 365 Customer Insights Customer Insights ішіндегі деректеріңізге негізделген жеке қолданбаларды құру үшін API интерфейстерін ұсынады.
...
NuGet.org сайтынан C# клиенттік кітапханаларын пайдалануды қалай бастау керектігін біліңіз. NuGet пакеті туралы қосымша ақпаратты қараңыз [Microsoft.Dynamics.CustomerInsights.Api](https://www.nuget.org/packages/Microsoft.Dynamics.CustomerInsights.Api/). Қазіргі уақытта бұл жиынтық netstandard2.0 және netcoreapp2.0 арқаулық жүйелеріне бағытталған.

#### <a name="add-the-c-client-library-to-a-c-project"></a>C# жобасына C# клиенттік кітапханасын қосыңыз

1. Visual Studio ішінде ашыңыз **NuGet пакет менеджері** сіздің жобаңыз үшін.

1. **Microsoft.Dynamics.CustomerInsights.Api** іздеңіз.

1. Жобаға жиынтық қосу үшін **Орнату** түймесін таңдаңыз.
 
   Немесе осы пәрменді файлда іске қосыңыз **NuGet Пакет менеджері консолі** :`Install-Package -Id Microsoft.Dynamics.CustomerInsights.Api -Source nuget.org -ProjectName <project name> [-Version <version>]`

   :::image type="content" source="media/visual-studio-nuget-package.gif" alt-text="NuGet бумасын Visual Studio жобасына қосыңыз.":::

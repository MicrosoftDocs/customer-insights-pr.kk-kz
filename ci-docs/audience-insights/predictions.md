...
[Жаңа ортаны](get-started-paid.md) жасасаңыз, оны **Ортаны жасау** диалогтық терезесінде теңшеп, **Кеңейтілген** параметрін таңдаңыз. Егер ортаны әлдеқашан жасап қойған болсаңыз, оның параметрлеріне өтіп, **Қосымша** опциясын таңдаңыз. Қалай болғанда да, **Болжамдарды қолдану** бөлімінде қоршаған ортаны қосқыңыз келетін Dataverse данасының URL мекенжайын енгізіңіз.

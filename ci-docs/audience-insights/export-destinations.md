...
> [!NOTE]
> 2021 жылдың наурыз айына дейін экспорттау тиісті қызметке автоматты түрде қосылым жасады. Экспорттау енді оларды жасамас бұрын [әкімші жасаған және бөліскен қосылымды](connections.md) қажет етеді.

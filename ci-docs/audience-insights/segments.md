...
2. **Жаңа** > **Бос сегмент** тармағын таңдаңыз.

3. **Жаңа сегмент** тақтасынан сегмент түрін таңдап, **Ат** беріңіз.

   Оған қоса, сегментті анықтауға көмектесетін сипаттама мен көрсетілетін атын беріңіз.

4. Топ анықталатын **Сегментті құрастыру құралы** бетіне өту үшін **Келесі** параметрін таңдаңыз. Топ — тұтынушылар жинағы.

5. Сегменттеу қажет төлсипаттан тұратын нысанды таңдаңыз.

6. Сегменттеу үшін төлсипат таңдаңыз. Бұл төлсипат төрт мәннің біреуіне ие болуы мүмкін: сандық, жолдық, күндік немесе логикалық.

7. Таңдалған төлсипат мәні мен операторды таңдаңыз.
...
9. Сегментті сақтау үшін **Сақтау** пәрменін таңдаңыз. Барлық талаптар тексерілсе, сегментіңіз сақталады және өңделеді. Болмаса, ол жоба ретінде сақталады.

10. **Сегменттер** бетіне кері өту үшін **Сегменттерге оралу** параметрін таңдаңыз.

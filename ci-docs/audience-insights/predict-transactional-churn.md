...
> [!TIP]
> Үлгілік деректерді пайдаланып, транзакцияны бұзу болжам оқулығын пайдаланып көріңіз: [Транзакцияны бұзу болжам үлгі нұсқаулығы](sample-guide-predict-transactional-churn.md).

---
title: Транзакция жылыстауының болжамы
...
ms.locfileid: "7643418"
---
# <a name="transaction-churn-prediction-preview"></a>Транзакция жылыстауының болжамы (алдын ала қарау нұсқасы)
...
> [!TIP]
> Үлгі деректерін пайдалану арқылы транзакция жылыстауы болжамының оқулығын көріңіз: [Транзакция жылыстауы болжамының (алдын ала қарау нұсқасы) үлгі нұсқаулығы](sample-guide-predict-transactional-churn.md).
...
- (Қосымша) Сіздің тұтынушыларыңыз туралы деректер:
    - Бұл деректер сирек болуы керек және үлгінің жақсы жұмыс істеуін қамтамасыз ету үшін көбірек статикалық төлсипаттарға сәйкес келуі керек.
...
1. Әрекетті сәйкес семантикалық түрге салыстырғаннан кейін, әрі қарай жалғастыру үшін **Келесі** опциясын таңдаңыз

1. Үлгіні іске қосу үшін қажет өрістерге семантикалық төлсипаттарды салыстырыңыз. Төмендегі өрістер толтырылмаған болса, сатып алу журналы нысанынан *тұтынушы* нысанына байланысты конфигурациялаңыз.
...
1. Қосалқы деңгей ретінде пайдалану керек төлсипатты таңдаңыз, содан кейін **Қосу** түймешігін таңдаңыз
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Эталондық тіркелгілердің қосымша тізімін беру (тек бизнес тіркелгілер)

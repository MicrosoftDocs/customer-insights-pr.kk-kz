...
- Dynamics 365 деректеріңіздің аудитория мәліметтері тұтынушы профильдерімен салыстырылуы үшін олар болуы керек [Microsoft Dataverse қосқышы арқылы Dynamics 365 қолданбасынан алынған](connect-power-query.md).
...
- Әр қондырманы басқару элементі аудитория туралы түсініктердегі нақты деректерге сүйенеді. Кейбір деректер мен басқару элементтері тек белгілі бір типтегі орталарда қолжетімді. Қондырма конфигурациясы таңдалған ортаның түріне байланысты басқару элементі қолжетімді болмаса, сізге хабарлайды. [Орталарды пайдалану жағдайлары](work-with-business-accounts.md) туралы қосымша ақпарат.
  ...
  - **Интеллект басқару элементі** [болжамдар](predictions.md) немесе [реттелетін үлгілер](custom-models.md) көмегімен жасалған деректерді қажет етеді.
  - **Тұтынушы мәліметтері басқару элементі**: профильдегі барлық өрістер бірыңғай тұтынушы профилінде қолжетімді.
  - **Арттыру басқару элементі**: тұтынушы профильдеріне қолданылған белсенді [арттыруларды](enrichment-hub.md) талап етеді. Карта қондырмасы мына байытуды қолдайды: [Брендтер](enrichment-microsoft.md) Microsoft ұсынған, [Қызығушылықтар](enrichment-microsoft.md) Microsoft ұсынған.
...
Тұтынушы картасының қондырмасы – Dynamics 365 жүйесіндегі Customer Engagement бағдарламаларының шешімі. Шешімді орнату үшін AppSource бетіне өтіп, іздеңіз **Dynamics тұтынушы картасы**. таңдаңыз [Тұтынушы картасының қондырмасы AppSource](https://appsource.microsoft.com/product/dynamics-365/mscrm.dynamics_365_customer_insights_customer_card_addin?tab=Overview) және таңдаңыз **Қазір алыңыз**.
...
1. таңдаңыз **Көрсетілетін атау** үшін сілтеме **Dynamics 365 Customer Insights Тұтынушы картасының қондырмасы (Алдын ала қарау)** шешім.

---
title: Dynamics 365 қолданбаларына арналған тұтынушы картасының қондырмасы (бейне)
...
- Dynamics 365 деректері аудитория туралы түсініктер тұтынушы профилінде көрсетілуі үшін олар [Microsoft Dataverse қосқышының көмегімен Dynamics 365 бағдарламасынан қабылдануы керек](connect-power-query.md).

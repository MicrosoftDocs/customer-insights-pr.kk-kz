...
1. Ішінде **Қосымша деректер (міндетті емес)** қадам, таңдаңыз **Деректерді қосыңыз** астында **Қосымша әрекет деректерімен модель туралы түсініктерді арттырыңыз**. [Алғышарттарда](#prerequisites) сипатталғандай тұтынушы әрекеті туралы ақпаратты ұсынатын тұтынушының әрекет нысанын таңдаңыз.
...
1. Қосымша тұтынушы деректерін қосыңыз немесе таңдаңыз **Келесі**.
...
1. Ішінде **Қосымша деректер (міндетті емес)** қадам, таңдаңыз **Деректерді қосыңыз** астында **Қосымша тұтынушы деректерімен модель туралы түсініктерді одан әрі арттырыңыз**.

1. Үшін **Нысан**, таңдау **Тұтынушы: CustomerInsights** тұтынушы төлсипатының деректерімен салыстырылатын бірыңғай тұтынушы профилінің кестесін таңдау үшін. Үшін **Тұтынушы идентификаторы**, таңдау **System.Customer.CustomerId**.

1. Деректер бірыңғай тұтынушы профильдерінде қолжетімді болса, көбірек өрістерді салыстырыңыз.

   :::image type="content" source="media/clv-optional-customer-profile-mapping.png" alt-text="Тұтынушы профилі деректеріне арналған салыстырылған өрістер мысалы.":::

1. таңдаңыз **Сақтау** Тұтынушының қызмет ету мерзімінің мәнін болжауға көмектесу үшін модель пайдалануы тиіс атрибуттарды салыстырғаннан кейін.

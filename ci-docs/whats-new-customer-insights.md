...
Қосымша ақпаратты қараңыз [Customer Lockbox (Алдын ала қарау) арқылы тұтынушы деректеріне қауіпсіз қол жеткізіңіз](security-overview.md#securely-access-customer-data-with-customer-lockbox-preview).
...
Қосымша ақпаратты қараңыз [Customer Insights жүйесінде жеке сілтемені пайдаланыңыз](security-overview.md#private-links-tab).
...
**Үй** негізгі мүмкіндіктер үшін конфигурациялау процесі арқылы бағыттайды және сегменттерге, өлшемдерге және байыту деректеріне шолу жасайды. Бір қарағанда маңыздырақ ақпарат беру үшін тәжірибені жаңарттық.
...
Қосымша ақпарат алу үшін қараңыз [Бүлінген деректер көздері](entities.md#corrupted-data-sources).

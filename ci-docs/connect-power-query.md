...
1. Сонымен қатар, деректеріңізді түрлендіре аласыз. Өңдейтін немесе түрлендіретін нысанды таңдаңыз. ішіндегі опцияларды пайдаланыңыз Power Query түрлендірулерді қолдану терезесі. Әрбір түрлендіру төменде берілген **Қолданылатын қадамдар**. Power Query алдын ала жасалған көптеген түрлендіру опцияларын ұсынады. Қосымша ақпаратты қараңыз [Power Query Трансформациялар](/power-query/power-query-what-is-power-query#transformations).
...
ішінде құсбелгі бар қосқыштар **Тұтынушы туралы мәліметтер (деректер ағындары)** баған негізінде жаңа деректер көздерін жасау үшін қолжетімді Power Query. Алғышарттары туралы көбірек білу үшін арнайы қосқыштың құжаттамасын қарап шығыңыз, [сұрау шектеулері](/power-query/power-query-online-limits), және басқа мәліметтер.

...
ms.locfileid: "8755505"
---
# <a name="customer-activities"></a>Тұтынушы әрекеттері

Dynamics 365 Customer Insights бағдарламасында [түрлі дерек көздерінен](data-sources.md) тұтынушы әрекеттерін біріктіріңіз. Әрекеттерді хронологиялық түрде тізімдейтін уақыт шкаласын жасаңыз. бар Dynamics 365 қолданбаларына уақыт шкаласын қосыңыз [Тұтынушы картасының қондырмасы](customer-card-add-in.md) шешім.
...
Тұтынушы конфигурацияланған әрекетке қатысқан болса, оны мына жерден табасыз **Белсенділік хронологиясы** бөлім.

...
Жүйе конфигурацияларына қол жеткізу үшін өтіңіз **Админ** > **Жүйе** жүйелік тапсырмалар мен процестердің тізімін көру үшін.
...
|Кезекке қойылған | Өңдеу кезекке қойылады және барлық жоғары ағындық тапсырмалар мен процестер аяқталғаннан кейін басталады. Қосымша ақпаратты қараңыз [Жаңарту процестері](#refresh-processes).|

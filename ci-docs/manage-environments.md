...
1. Біздің инженерден іске қосу үшін қажет екі PowerShell сценарийін жүктеп алыңыз [GitHub репо](https://github.com/trin-msft/byol).
    1. `CreateSecurityGroups.ps1`
       ...
       - Бұл PowerShell сценарийін Windows PowerShell жүйесінде орындаңыз Azure Data Lake Storage. Қосымша ақпаратты және орындалған логиканы қарап шығу үшін PowerShell сценарийін өңдегіште ашыңыз.

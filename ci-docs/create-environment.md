...
- **Атауы**: осы ортаның атауы. Бар ортадан көшірсеңіз, бірақ оны өзгерте алмасаңыз, осы өріс толтырулы болады. Егер сізде бірнеше жұмыс ортасы болса, әрқайсысына оңай анықталатын атау беріңіз.
...
- **Azure Data Lake Storage**: Өзіңізді көрсетіңіз Azure Data Lake Storage деректердің қай жерде сақталатынын толық бақылауыңыз үшін деректерді сақтау үшін есептік жазбаны пайдаланыңыз. Қосымша ақпаратты қараңыз [Өзіңізді пайдаланыңыз Azure Data Lake Storage есептік жазба](own-data-lake-storage.md).
...
**Microsoft Dataverse** қадамы Customer Insights бағдарламасын Dataverse ортасымен байланыстыруға мүмкіндік береді. Деректермен бөлісіңіз Dataverse негізінде іскери қолданбалармен пайдалану Dataverse, мысалы, Dynamics 365 Marketing немесе үлгіге негізделген қолданбалар Power Apps.

Өзіңіздің өрісіңіз болмаса, бұл өрісті бос қалдырыңыз Dataverse орта және біз сіз үшін біреуін жасаймыз.

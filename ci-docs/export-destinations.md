...
- **Деректерді экспорттау** Customer Insights ішінде қол жетімді кез келген нысан түрін экспорттауға мүмкіндік береді. Экспорттау үшін таңдаған нысандар барлық деректер өрістерімен, метадеректермен, схемалармен және салыстыру мәліметтерімен экспортталады. 

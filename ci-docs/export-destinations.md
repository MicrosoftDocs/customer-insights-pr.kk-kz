...
**Мәселе** Іскерлік тіркелгілер ортасында сіздің экспортыңыз қате туралы хабармен орындалмайды: «Келесі сегмент осы экспорттау мақсатына жарамсыз: '{ сегмент атауы} '. ContactProfile түріндегі сегменттерді ғана таңдап, әрекетті қайталаңыз."

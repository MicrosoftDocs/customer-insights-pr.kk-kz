...
- Деректер көлі қоймасындағы деректер деректеріңізді сақтауға арналған Жалпы деректер үлгісі стандартына сәйкес болуы және деректер файлдарының схемасын (*.csv немесе *.parquet) көрсету үшін жалпы деректер үлгісінің манифестіне ие болуы керек. Манифест нысан бағандары мен деректер түрлері, деректер файлының орны мен файл түрі сияқты нысандардың мәліметтерін қамтамасыз етуі керек. Қосымша ақпаратты қараңыз [Жалпы деректер үлгісі манифесті](/common-data-model/sdk/manifest). Манифест жоқ болса, Storage Blob деректерінің иесі немесе Storage Blob деректер қатысушысы қатынасы бар әкімші пайдаланушылары деректерді қабылдау кезінде схеманы анықтай алады.

## <a name="connect-to-azure-data-lake-storage"></a>Azure Data Lake Storage қызметіне қосылу
...
1. А енгізіңіз **Аты** деректер көзі және қосымша үшін **Сипаттама**. Атау деректер көзі файлын бірегей түрде анықтайды және төменгі ағындық процестерде сілтеме жасалады және оны өзгерту мүмкін емес.
...
1. Келесі опциялардың бірін таңдаңыз **көмегімен жадты қосыңыз**. Қосымша ақпаратты қараңыз [Customer Insights қолданбасына қосыңыз Azure Data Lake Storage Azure қызмет көрсетушісімен Gen2 тіркелгісі](connect-service-principal.md).
   ...
   - **Azure ресурсы** : енгізіңіз **Ресурс идентификаторы** . Қосымша, деректерді сақтау тіркелгісінен Azure Private Link арқылы қабылдағыңыз келсе, таңдаңыз **Жеке сілтемені қосыңыз**. Қосымша ақпаратты қараңыз [Жеке сілтемелер](security-overview.md#private-links-tab).
   - **Azure жазылымы** : таңдаңыз **Жазылым** содан кейін **Ресурстар тобы** және **Сақтау тіркелгісі**. Қосымша, деректерді сақтау тіркелгісінен Azure Private Link арқылы қабылдағыңыз келсе, таңдаңыз **Жеке сілтемені қосыңыз**. Қосымша ақпаратты қараңыз [Жеке сілтемелер](security-overview.md#private-links-tab).
...
1. атын таңдаңыз **Контейнер** ол деректерді импорттау үшін деректер мен схеманы (model.json немесе manifest.json файлы) қамтиды және таңдаңыз **Келесі**.
   > [!NOTE]
...
1. Қосқыңыз келетін нысандарды таңдаңыз.
   ...
   > [!TIP]
   > JSON өңдеу интерфейсіндегі нысандарды өңдеу үшін таңдаңыз **Көбірек көрсет** > **Схема файлын өңдеу**. Өзгерістерді енгізіп, таңдаңыз **Сақтау**.
...
1. санын таңдаңыз **Атрибуттар** әрбір енгізілген нысан үшін. The **Атрибуттарды басқару** бетті көрсетеді.
   ...
   1. Жаңа атрибуттарды жасаңыз, бар төлсипаттарды өңдеңіз немесе жойыңыз. Атын, деректер пішімін өзгертуге немесе семантикалық түрді қосуға болады.

...
- Azure субъек-қызметімен аутентификациялау үшін оның қатысушыда конфигурацияланғандығына көз жеткізіңіз. Қосымша ақпарат алу үшін қараңыз [қосылыңыз Azure Data Lake Storage Azure қызмет көрсетушісімен Gen2 тіркелгісі](connect-service-principal.md).
...
- деректер көзі қосылымын орнатқан пайдаланушыға сақтау тіркелгісінде ең аз Storage Blob Data Contributor рұқсаттары қажет.
...
Оңтайлы өнімділік үшін Customer Insights бөлімнің өлшемін 1 ГБ немесе одан аз болуын және қалтадағы бөлім файлдарының саны 1000-нан аспауын ұсынады.
...
1. Келесі опциялардың бірін таңдаңыз **көмегімен жадты қосыңыз**. Қосымша ақпаратты қараңыз [Customer Insights қолданбасына қосыңыз Azure Data Lake Storage Azure қызмет көрсетушісімен Gen2 тіркелгісі](connect-service-principal.md).
   ...
   - **Azure ресурсы** : енгізіңіз **Ресурс идентификаторы** . Қосымша, Azure Private Link арқылы сақтау тіркелгісінен деректерді алғыңыз келсе, таңдаңыз **Жеке сілтемені қосыңыз**. Қосымша ақпаратты қараңыз [Жеке сілтемелер](security-overview.md#set-up-an-azure-private-link).
   - **Azure жазылымы** : таңдаңыз **Жазылым** содан кейін **Ресурстар тобы** және **Сақтау тіркелгісі**. Қосымша, Azure Private Link арқылы сақтау тіркелгісінен деректерді алғыңыз келсе, таңдаңыз **Жеке сілтемені қосыңыз**. Қосымша ақпаратты қараңыз [Жеке сілтемелер](security-overview.md#set-up-an-azure-private-link).
...
1. Келесі ақпараттың кез келгенін өзгертіңіз:
   ...
   - **Жеке сілтемені қосыңыз** Azure Private Link арқылы сақтау тіркелгісінен деректерді алғыңыз келсе. Қосымша ақпаратты қараңыз [Жеке сілтемелер](security-overview.md#set-up-an-azure-private-link).
...
1. Төмендегілердің кез келгенін өзгертіңіз:
   ...
   - Қабылдау үшін қосымша нысандарды қосу үшін таңдаңыз **Жаңа нысан**.
...
Деректерді қабылдау кезінде жазбаны бүлінген деп санаудың ең көп таралған себептеріне мыналар жатады:

- Деректер түрлері мен өріс мәндері бастапқы файл мен схема арасында сәйкес келмейді
- Бастапқы файлдағы бағандар саны схемаға сәйкес келмейді
- Өрістерде күтілетін схемамен салыстырғанда бағандардың қисаюына әкелетін таңбалар бар. Мысалы: қате пішімделген тырнақшалар, бос тырнақшалар, жаңа жол таңбалары немесе қойынды таңбалары.
- Бөлім файлдары жоқ
- Datetime/date/datetimeoffset бағандары болса, стандартты пішімге сәйкес келмесе, олардың пішімі схемада көрсетілуі керек.

### <a name="schema-or-data-type-mismatch"></a>Схема немесе деректер түрі сәйкес келмеді

Деректер схемаға сәйкес келмесе, қабылдау процесі қателермен аяқталады. Бастапқы деректерді немесе схеманы түзетіп, деректерді қайта қабылдаңыз.

### <a name="partition-files-are-missing"></a>Бөлім файлдары жоқ

- Ешқандай бүлінген жазбаларсыз енгізу сәтті болса, бірақ ешқандай деректерді көре алмасаңыз, бөлімдердің көрсетілгеніне көз жеткізу үшін model.json немесе manifest.json файлын өңдеңіз. Содан кейін, [деректер көзі жаңартыңыз](data-sources.md#refresh-data-sources).

- Деректерді қабылдау кестені автоматты түрде жаңарту кезінде деректер көздері жаңартылып жатқан кезде бір уақытта орын алса, бөлім файлдары бос болуы немесе Customer Insights өңдеуі үшін қол жетімді болмауы мүмкін. Жоғары ағынды жаңарту кестесімен туралау үшін параметрін өзгертіңіз [жүйені жаңарту кестесі](schedule-refresh.md) немесе деректер көзі үшін жаңарту кестесі. Жаңартулардың барлығы бірден болмайтындай және Customer Insights бағдарламасында өңделетін соңғы деректерді беретіндей уақытты туралаңыз.

### <a name="datetime-fields-in-the-wrong-format"></a>Datetime өрістері қате пішімде

Нысандағы datetime өрістері ISO 8601 немесе en-US пішімінде емес. Customer Insights бағдарламасындағы әдепкі күн пішімі en-US пішімі болып табылады. Нысандағы барлық datetime өрістері бірдей пішімде болуы керек. Customer Insights үлгісі немесе manifest.json файлындағы дереккөз немесе нысан деңгейінде аннотациялар немесе белгілер жасалған жағдайда басқа пішімдерді қолдайды. Мысалы:
...
**Model.json**
  ...
  manifest.json файлында datetime пішімін нысан деңгейінде немесе төлсипат деңгейінде көрсетуге болады. Нысан деңгейінде datetime пішімін анықтау үшін *.manifest.cdm.json ішіндегі нысандағы "exhibitsTraits" пайдаланыңыз. Атрибут деңгейінде entityname.cdm.json төлсипатында "appliedTraits" пайдаланыңыз.

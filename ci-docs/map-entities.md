...
ms.locfileid: "8643168"
---
# <a name="map-entities-and-attributes"></a>Нысандар мен төлсипаттарды салыстыру

**Карта** деректерді унификациялау процесінің бірінші кезеңі болып табылады. Салыстыру түсіру үш кезеңнен тұрады:
...
1. **Деректер** > **Біріктіру** > **Салыстыру** тармағына өтіңіз.

...
- Azure жүйесіндегі жарамды ресурс [тағайындалған жерге қойылатын талаптар](/azure/azure-monitor/platform/diagnostic-settings#destination-requirements) Azure Storage, Azure Event Hub немесе Azure Log Analytics үшін.
- [Қатысушы және пайдаланушыға қол жеткізу әкімшісі рөлі](/azure/role-based-access-control/role-assignments-portal) Azure жүйесіндегі тағайындалған ресурста. Ресурс болуы мүмкін Azure Data Lake Storage тіркелгісі, Azure Event Hub немесе Azure Log Analytics жұмыс кеңістігі. Бұл рұқсат Customer Insights жүйесінде диагностикалық параметрлерді теңшеу кезінде қажет, бірақ оны сәтті орнатудан кейін өзгертуге болады.
...
## <a name="log-categories-and-event-schemas"></a>Журнал санаттары мен оқиғалар схемалары
...
API оқиғалары мен жұмыс процесі оқиғаларының жалпы құрылымы бар, бірақ аздаған айырмашылықтары бар. Қосымша ақпарат алу үшін қараңыз [API оқиға схемасы](#api-event-schema) немесе [жұмыс процесі оқиғасының схемасы](#workflow-event-schema) .
...
| Өріс                         | Сипаттама                                                                                                                          |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `Authorization.UserRole`      | Пайдаланушы немесе қолданба үшін тағайындалған рөл. Қосымша ақпарат алу үшін қараңыз [пайдаланушы рұқсаттары](permissions.md) .                                     |
...
| `properties.operationStatus` | `Success` for HTTP Status code < 400 <br> `ClientError` for HTTP Status code < 500 <br> `Error` HTTP күйі үшін >= 500 |

...
description: Біріктіру параметрлеріндегі қайталанатын ережелерді, сәйкестік ережелерін немесе біріктірілген өрістерді жаңартыңыз.
ms.date: 06/01/2022
...
1. таңдаңыз **Келесі** қайталау ережелеріне өзгертулер енгізу үшін немесе таңдаңыз **Сақтау және жабу** және қайту [Біріктіру параметрлерін жаңартыңыз](#update-the-unification-settings).
...
Сәйкестік шарттарын іске қосу тек көшіру мен сәйкестік ережелерін іске қосады және жаңартады *қайталану_* * және *ConflationMatchPair* субъектілері.
...
1. бастап **Деректер** > **Біріктіру** бет, таңдаңыз:
   ...
   - **Тұтынушы профильдерін біріктіру** : Сәйкес шарттарды іске қосады және тәуелділіктерге (байытулар, сегменттер немесе өлшемдер сияқты) әсер етпестен бірыңғай тұтынушы профилі нысанын жаңартады. Тәуелді процестер іске қосылмайды, бірақ келесідей жаңартылады [жаңарту кестесінде анықталған](schedule-refresh.md).

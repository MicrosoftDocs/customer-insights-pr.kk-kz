...
1. Деректерді қабылдау конфигурациясын қарап шығыңыз. GUID контакті идентификаторы бар Dynamics 365 жүйесі үшін деректер көзі файлын өңдеңіз. GUID контактісінің идентификаторы бас әріптермен көрсетілсе Power Query редакторында келесі қадамдарды орындап көріңіз:

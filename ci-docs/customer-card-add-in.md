...
- Кейбір деректер мен басқару элементтері тек белгілі бір типтегі орталарда қолжетімді. Таңдалған орта түріне байланысты басқару элементі қол жетімді болмаса, қондырма конфигурациясы сізге хабарлайды. Бұл қате оны көрсету кезінде басқару элементінде көрсетіледі. [Орталарды пайдалану жағдайлары](work-with-business-accounts.md) туралы қосымша ақпарат.
- Әрбір қондырманы басқару Customer Insights ішіндегі арнайы деректерге сүйенеді.
  - **Өлшемді бақылау** талап етеді [конфигурацияланған тұтынушы атрибут өлшемдері](measures.md).
  - **Интеллект бақылауы** көмегімен жасалған мәліметтерді қажет етеді [болжамдар немесе пайдаланушы үлгілері](predictions-overview.md).

...
Құрылғаннан кейін а *ContactProfile* мағыналық нысанды салыстыру арқылы контактілердің әрекеттерін түсіруге болады. Ол әрбір әрекетке қай контакт жауапты болған тіркелгінің әрекет уақыт кестесінде көруге мүмкіндік береді. Көптеген қадамдар әдеттегі әрекетті салыстыру конфигурациясына сәйкес келеді.

   > [!NOTE]
   > Байланыс деңгейіндегі әрекеттер жұмыс істеуі үшін сізде екеуі де болуы керек **Тіркелгі идентификаторы** және **Контакт идентификаторы** әрекет деректеріндегі әрбір жазбаның төлсипаттары.

1. [Анықтаңыз а *ContactProfile* мағыналық нысанды бейнелеу.](#define-a-contactprofile-semantic-entity-mapping) және семантикалық картаны іске қосыңыз.
